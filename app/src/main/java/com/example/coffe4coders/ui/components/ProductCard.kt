...
enum class  CountryISO(val iso: String){
    COL("COL"), BRA("BRA"), CRI("CRI"), NIC("NIC");
    ...
    Card(
        ...
        Surface(
            ...
            Column(
                ...
                Text(text = product.summary, style = MaterialTheme.typography.body1, textAlign = TextAlign.Center)
                Column(
                    ...
                    Row(
                        ...
                        Text(text = "$ ${product.price} ${product.currency}", style = MaterialTheme.typography.h4)
                    }
                }
            }
        }
